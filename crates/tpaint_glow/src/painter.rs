...
use tpaint::epaint::textures::{TextureFilter, TextureOptions, TexturesDelta};
use tpaint::epaint::*;
...
pub struct Painter {
    ...
    textures: HashMap<TextureId, glow::Texture>,
...
impl Painter {
        ...
        unsafe {
            ...
            let buffer_infos = vec![
                vao::BufferInfo {
                    ...
                    normalized: false,
                    stride,
                    offset: bytemuck::offset_of!(Vertex, pos) as i32,
                },
                vao::BufferInfo {
                    location: a_tc_loc,
                    vector_size: 2,
                    ...
                    normalized: false,
                    stride,
                    offset: bytemuck::offset_of!(Vertex, uv) as i32,
                },
                vao::BufferInfo {
    ...
    /// Get the [`glow::Texture`] bound to a [`TextureId`].
    pub fn texture(&self, texture_id: TextureId) -> Option<glow::Texture> {
        self.textures.get(&texture_id).copied()
    }

    #[deprecated = "renamed 'texture'"]
    pub fn get_texture(&self, texture_id: TextureId) -> Option<glow::Texture> {
        self.texture(texture_id)
    }

    #[allow(clippy::needless_pass_by_value)] // False positive
    pub fn register_native_texture(&mut self, native: glow::Texture) -> TextureId {
        self.assert_not_destroyed();
    ...
    #[allow(clippy::needless_pass_by_value)] // False positive
    pub fn replace_native_texture(&mut self, id: TextureId, replacing: glow::Texture) {
