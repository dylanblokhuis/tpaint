      ...
      view {
        ...
        view {
          ...
          view {
              ...
              view {
                  class: "w-200 h-200 p-15 bg-rose-900 shrink-0 overflow-x-scroll scrollbar-default",

                  view {
                      class: "w-100 h-100 bg-blue-300",
                  }
                  // view {
          ...
          view {
              class: "w-400 h-400 p-10 overflow-x-scroll bg-green-300 scrollbar-default",

              view {
                  class: "w-100 h-200 p-10 bg-green-900",
              }

              view {
                  class: "w-600 h-200 p-10 bg-blue-900",
              }
          }
